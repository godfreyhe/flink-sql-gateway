...
import com.ververica.flink.table.rest.handler.GetInfoHandler;
import com.ververica.flink.table.rest.handler.GetInfoHeaders;
import com.ververica.flink.table.rest.handler.JobCancelHandler;
import com.ververica.flink.table.rest.handler.JobCancelHeaders;
import com.ververica.flink.table.rest.handler.JobStatusHandler;
import com.ververica.flink.table.rest.handler.JobStatusHeaders;
import com.ververica.flink.table.rest.handler.ResultFetchHandler;
import com.ververica.flink.table.rest.handler.ResultFetchHeaders;
import com.ververica.flink.table.rest.handler.SessionCloseHandler;
import com.ververica.flink.table.rest.handler.SessionCloseHeaders;
import com.ververica.flink.table.rest.handler.SessionCreateHandler;
import com.ververica.flink.table.rest.handler.SessionCreateHeaders;
import com.ververica.flink.table.rest.handler.SessionHeartbeatHandler;
import com.ververica.flink.table.rest.handler.SessionHeartbeatHeaders;
import com.ververica.flink.table.rest.handler.StatementCompleteHandler;
import com.ververica.flink.table.rest.handler.StatementCompleteHeaders;
import com.ververica.flink.table.rest.handler.StatementExecuteHandler;
import com.ververica.flink.table.rest.handler.StatementExecuteHeaders;
import com.ververica.flink.table.rest.handler.StatementExecuteWithoutSessionHandler;
import com.ververica.flink.table.rest.handler.StatementExecuteWithoutSessionHeaders;
...
/**
 * SqlClientGatewayEndpoint.
 */
public class SqlClientGatewayEndpoint extends RestServerEndpoint {

	private final SessionManager sessionManager;

	public SqlClientGatewayEndpoint(
	...
	protected List<Tuple2<RestHandlerSpecification, ChannelInboundHandler>> initializeHandlers(
		...
		StatementExecuteWithoutSessionHandler statementExecuteWithoutSessionHandler = new StatementExecuteWithoutSessionHandler(
			sessionManager, timeout, responseHeaders, StatementExecuteWithoutSessionHeaders.getInstance());

		StatementCompleteHandler statementCompleteHandler = new StatementCompleteHandler(
			sessionManager, timeout, responseHeaders, StatementCompleteHeaders.getInstance());
		...
		handlers.add(
			Tuple2.of(StatementExecuteWithoutSessionHeaders.getInstance(), statementExecuteWithoutSessionHandler));
		handlers.add(Tuple2.of(StatementCompleteHeaders.getInstance(), statementCompleteHandler));
