...
public class ShowCatalogOperation implements NonJobOperation {
	...
	public ShowCatalogOperation(String sessionId, Executor executor) {
	...
	public ResultSet execute() {
		return OperationUtil.stringListToResultSet(executor.listCatalogs(sessionId), ConstantNames.CATALOGS);
	}
}
