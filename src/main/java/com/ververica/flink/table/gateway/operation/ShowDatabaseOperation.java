...
public class ShowDatabaseOperation implements NonJobOperation {
	...
	public ShowDatabaseOperation(String sessionId, Executor executor) {
	...
	public ResultSet execute() {
		return OperationUtil.stringListToResultSet(executor.listDatabases(sessionId), ConstantNames.DATABASES);
	}
}
